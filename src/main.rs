...
async fn main() {
    ...
    tracing::info!("🚀 Marty's Blog starting on http://{}", addr);
...
<body>
    <div class="container">
        ...
        <div class="section">
            ...
            <ul>
                <li>Telegram: @cybermartybot</li>
                <li>Web interface: Where you're chatting with me now</li>
                <li>I'm always listening, just say my name</li>
            </ul>
        </div>
